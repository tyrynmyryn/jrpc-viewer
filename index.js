...
const initExtention = (afterReload, afterRequest) => {
  var _a;
  const panels = chrome && chrome.devtools && chrome.devtools.panels;
  if (!panels)
    return;
  panels.create("JRPC viewer", "icon.png", "index.html");
  chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
    if (changeInfo.status == "loading")
      ;
  });
  if ((_a = chrome.devtools) == null ? void 0 : _a.network) {
    chrome.devtools.network.onRequestFinished.addListener((request) => {
      if (request.request && request.request.postData && request.request.postData.mimeType && request.request.postData.mimeType.match(/application\/json/) && request.request.postData.text && request.request.postData.text.match(/jsonrpc/)) {
        request.getContent((content) => {
          afterRequest(request, content);
        });
      }
    });
  }
    ...
    var DOMIterator = function() {
      ...
      createClass(DOMIterator2, [{
        ...
        value: function checkIframeFilter(node, prevNode, currIfr, ifr) {
          ...
          ifr.forEach(function(ifrDict, i2) {
    ...
    var Mark$1 = function() {
      ...
      createClass(Mark3, [{
        ...
        value: function getSeparatedKeywords(sv) {
          ...
          sv.forEach(function(kw) {
            if (!_this2.opt.separateWordSearch) {
              if (kw.trim() && stack2.indexOf(kw) === -1) {
                stack2.push(kw);
              }
            } else {
              kw.split(" ").forEach(function(kwSplitted) {
                if (kwSplitted.trim() && stack2.indexOf(kwSplitted) === -1) {
                  stack2.push(kwSplitted);
                }
              });
            }
          });
          return {
            "keywords": stack2.sort(function(a2, b2) {
              return b2.length - a2.length;
            }),
            "length": stack2.length
          };
        }
      }, {
        key: "isNumeric",
        ...
        value: function wrapRangeInMappedTextNode(dict, start, end, filterCb, eachCb) {
          var _this5 = this;
          dict.nodes.every(function(n2, i2) {
            var sibl = dict.nodes[i2 + 1];
            if (typeof sibl === "undefined" || sibl.start > start) {
              if (!filterCb(n2.node)) {
                return false;
              }
              var s2 = start - n2.start, e = (end > n2.end ? n2.end : end) - n2.start, startStr = dict.value.substr(0, n2.start), endStr = dict.value.substr(e + n2.start);
              n2.node = _this5.wrapRangeInTextNode(n2.node, s2, e);
              dict.value = startStr + endStr;
              dict.nodes.forEach(function(k2, j2) {
                if (j2 >= i2) {
                  if (dict.nodes[j2].start > 0 && j2 !== i2) {
                    dict.nodes[j2].start -= e;
                  }
                  dict.nodes[j2].end -= e;
                }
              });
...
const Search = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-17073c69"]]);
const _withScopeId$1 = (n2) => (pushScopeId("data-v-eb39929b"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_3$4 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", {
  d: "M11 7.9875L10.1125 8.875L6 4.7625L1.8875 8.875L1 7.9875L6 2.9875L11 7.9875Z",
  fill: "currentColor"
}, null, -1));
const _hoisted_4$4 = [
  _hoisted_3$4
...
const _hoisted_6 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", {
  d: "M1 4.0125L1.8875 3.125L6 7.2375L10.1125 3.125L11 4.0125L6 9.0125L1 4.0125Z",
  fill: "currentColor"
}, null, -1));
const _hoisted_7 = [
  _hoisted_6
...
const _hoisted_9 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", {
  d: "M4 9C3.725 9 3.48958 8.90208 3.29375 8.70625C3.09792 8.51042 3 8.275 3 8V2C3 1.725 3.09792 1.48958 3.29375 1.29375C3.48958 1.09792 3.725 1 4 1H8.5C8.775 1 9.01042 1.09792 9.20625 1.29375C9.40208 1.48958 9.5 1.725 9.5 2V8C9.5 8.275 9.40208 8.51042 9.20625 8.70625C9.01042 8.90208 8.775 9 8.5 9H4ZM4 8H8.5V2H4V8ZM2 11C1.725 11 1.48958 10.9021 1.29375 10.7063C1.09792 10.5104 1 10.275 1 10V3H2V10H7.5V11H2Z",
  fill: "currentColor"
}, null, -1));
const _hoisted_10 = [
  _hoisted_9
...
const _hoisted_12 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("path", { d: "M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" }, null, -1));
const _hoisted_13 = [
  _hoisted_12
];
const _sfc_main$8 = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return __props.name ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
        __props.name === "arrow-up" ? (openBlock(), createElementBlock("svg", _hoisted_2$6, _hoisted_4$4)) : createCommentVNode("", true),
        __props.name === "arrow-down" ? (openBlock(), createElementBlock("svg", _hoisted_5$1, _hoisted_7)) : createCommentVNode("", true),
        __props.name === "copy" ? (openBlock(), createElementBlock("svg", _hoisted_8, _hoisted_10)) : createCommentVNode("", true),
        __props.name === "trash" ? (openBlock(), createElementBlock("svg", _hoisted_11, _hoisted_13)) : createCommentVNode("", true)
      ])) : createCommentVNode("", true);
    };
  }
};
const Icon = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-eb39929b"]]);
const _hoisted_1$7 = { class: "view" };
const _hoisted_2$5 = { class: "controls" };
const _hoisted_3$3 = { class: "search-count" };
const _hoisted_4$3 = { class: "icons" };
const _sfc_main$7 = {
  __name: "JsonView",
  props: {
    json: {
  ...
  setup(__props) {
    ...
    const activeSearchNodeIndex = ref(0);
    const jsonRef = ref(null);
    const markInstance = ref(null);
    onMounted(() => {
      markInstance.value = new Mark(jsonRef.value.$el);
    });
    const onSearch = (e) => {
      search.value = e.target.value;
      markInstance.value.unmark();
      searchNodes.value = [];
      markInstance.value.mark(search.value, {
        each: (node) => {
          searchNodes.value.push(node);
        },
        done: () => {
          activeSearchNodeIndex.value = -1;
        }
      });
    };
    const scrollToActiveSearchIndex = () => {
      const node = searchNodes.value[activeSearchNodeIndex.value];
      if (!node)
        return;
      node.classList.add("active");
      node.scrollIntoView();
    };
    const setActiveNodeIndex = (index) => {
      const currentActiveNode = searchNodes.value[activeSearchNodeIndex.value];
      if (currentActiveNode) {
        currentActiveNode.classList.remove("active");
      }
      if (index > searchNodes.value.length - 1) {
        index = 0;
      }
      if (index < 0) {
        index = searchNodes.value.length - 1;
      }
      activeSearchNodeIndex.value = index;
      scrollToActiveSearchIndex();
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createBaseVNode("div", _hoisted_2$5, [
          ...
          createBaseVNode("span", _hoisted_3$3, [
            createBaseVNode("span", null, toDisplayString(Math.min(searchNodes.value.length, activeSearchNodeIndex.value + 1)), 1),
            createTextVNode(" из "),
            createBaseVNode("span", null, toDisplayString(searchNodes.value.length), 1)
          ]),
          createBaseVNode("div", _hoisted_4$3, [
            createVNode(Icon, {
              name: "arrow-up",
              class: "icon",
              onClick: _cache[0] || (_cache[0] = () => setActiveNodeIndex(activeSearchNodeIndex.value - 1))
            }),
            createVNode(Icon, {
              name: "arrow-down",
              class: "icon",
              onClick: _cache[1] || (_cache[1] = () => setActiveNodeIndex(activeSearchNodeIndex.value + 1))
            }),
            createVNode(Icon, {
              name: "copy",
              class: "icon copy",
              onClick: _cache[2] || (_cache[2] = () => unref(handleCopy)(JSON.stringify(__props.json, null, 2)))
            })
          ])
        ]),
        createVNode(unref(S), {
...
const JsonView = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-5c9ac7c0"]]);
const _hoisted_1$6 = {
  key: 0,
  class: "name"
};
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.name ? (openBlock(), createElementBlock("div", _hoisted_1$6, toDisplayString(__props.name), 1)) : createCommentVNode("", true),
        __props.time ? (openBlock(), createElementBlock("div", _hoisted_2$4, toDisplayString(__props.time), 1)) : createCommentVNode("", true)
      ], 2);
    };
  }
};
const Method = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-1422113d"]]);
const _sfc_main$5 = {};
const _hoisted_1$5 = { class: "button" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("button", _hoisted_1$5, [
    renderSlot(_ctx.$slots, "default", {}, void 0)
  ]);
}
const Button = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render], ["__scopeId", "data-v-432b2be7"]]);
const _withScopeId = (n2) => (pushScopeId("data-v-014977eb"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$4 = { class: "sidebar" };
const _hoisted_2$3 = { class: "header" };
const _hoisted_3$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h2", { class: "title" }, "Методы", -1));
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    const emit2 = __emit;
    const onClickItem = (method) => {
      emit2("onClickItem", method);
    };
    const onClickClearAll = (e) => {
      emit2("onClickClearAll");
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$3, [
          _hoisted_3$2,
          createVNode(Button, { onClick: onClickClearAll }, {
            default: withCtx(() => [
              createVNode(Icon, {
                name: "trash",
                class: "icon"
        ...
        createBaseVNode("div", _hoisted_4$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (method) => {
            return openBlock(), createBlock(Method, mergeProps({ ref_for: true }, method, {
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-014977eb"]]);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$3, toDisplayString(__props.name), 1)
      ], 2);
    };
  }
};
const Tab = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-720abdee"]]);
const _hoisted_1$2 = { class: "container" };
const _hoisted_2$2 = { class: "header" };
const _hoisted_3$1 = { class: "tabs" };
        ...
        createBaseVNode("div", _hoisted_2$2, [
          createBaseVNode("div", _hoisted_3$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.tabs, (tab) => {
              return openBlock(), createBlock(Tab, mergeProps({ ref_for: true }, tab, {
                onClick: () => _ctx.$emit("on-click-tab", tab)
              }), null, 16, ["onClick"]);
            }), 256))
          ])
        ]),
...
const Content = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ba1c1348"]]);
const _hoisted_1$1 = { class: "info" };
const _hoisted_2$1 = { class: "items" };
        ...
        createBaseVNode("div", _hoisted_2$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (item) => {
            return openBlock(), createElementBlock("div", _hoisted_3, [
              createBaseVNode("div", _hoisted_4, toDisplayString(item.key), 1),
...
const Info = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-31b92c7f"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const onClickContentTab = (tab) => {
      tabs.value.forEach((t2) => {
        t2.selected = t2.name === tab.name;
      });
    };
    const onClearAll = () => {
      data.value = {};
    ...
    onMounted(() => {
      const afterRequest = (request, content) => {
        ...
        const info = [
          {
            key: "Полный путь",
            value: (_c = request.request) == null ? void 0 : _c.url
          }
        ];
        data.value[v4()] = {
          [keys.method]: method,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createVNode(Sidebar, {
            items: methods.value,
            onOnClickItem: onClickMethod,
            onOnClickClearAll: onClearAll
          }, null, 8, ["items"]),
          selectedItem.value ? (openBlock(), createBlock(Content, {
            key: 0,
            tabs: tabs.value,
